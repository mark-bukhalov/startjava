public class JaegerTest {
    public static void main(String[] args) {
        ...
        System.out.printf("Mark : %s%nOrigin: %s%nSpeed: %d", strikerEureka.getMark(), strikerEureka.getOrigin(), strikerEureka.getSpeed());
        strikerEureka.drift();
        ...
        Jaeger brawlerYukon = new Jaeger("Brawler Yukon", "Mark-1", "United States of America",
                60);
        System.out.printf("%n%nИнформация о %s%n", brawlerYukon.getModelName());
        System.out.printf("Mark : %s%nOrigin: %s%nSpeed: %d", brawlerYukon.getMark(), brawlerYukon.getOrigin(), brawlerYukon.getSpeed());
        brawlerYukon.drift();
        ...
        if (strikerEureka.getSpeed() > brawlerYukon.getSpeed()) {
            ...
            System.out.printf("%s медленее чем %s", strikerEureka.getModelName(), brawlerYukon.getModelName());
        } else {
            System.out.printf("%s и %s имеют равную скорость", strikerEureka.getModelName(), brawlerYukon.getModelName());
        }
    }
}
